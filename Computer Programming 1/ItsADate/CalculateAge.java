...
public class CalculateAge {
  ...
  System.out.println("You are " + milleniums + " millenia, " + centuries + " century, " + decades + " decade(s), " + years + " year(s), " + months + " month(s), " + days + " day(s), " + hours + " hour(s), " + minutes + " minute(s), " + seconds + " second(s) old.");
}
